...
# CREDIT TO https://github.com/tjmoon0104/pytorch-tiny-imagenet/

DATASET_URL = "http://cs231n.stanford.edu/tiny-imagenet-200.zip"
DATASET_ZIP = Path("files/tiny-imagenet-200.zip")
...
ORIGINAL_DATASET_DIR = Path("files/original/")
...
# Remove existing data set
DATASET_DIR = Path("files/tiny-imagenet-200")
...
RESIZED_DIR = Path("files/tiny-224")
